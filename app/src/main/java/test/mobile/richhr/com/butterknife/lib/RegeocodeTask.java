...
package test.mobile.richhr.com.butterknife.lib;
...
public class RegeocodeTask implements OnGeocodeSearchListener
{
	...
	public void search(double latitude, double longitude) {
		...
		Logger.e("search " + latitude + ", " + longitude);
	}
	...
	public void onGeocodeSearched(GeocodeResult arg0, int arg1) {
		Logger.e("onGeocodeSearched " + arg0 + ", " + arg1);
	}

	@Override
	public void onRegeocodeSearched(RegeocodeResult regeocodeReult,
			int resultCode) {
		Logger.e("onRegeocodeSearched " + regeocodeReult + ", " + resultCode);
		if (resultCode == 1000) {
